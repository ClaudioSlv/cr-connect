...
export default function LoginPage() {
  ...
  if (busy && !notice) {
    return <main className="grid min-h-screen place-items-center bg-[#0E0E0E] p-6 text-zinc-400">Verificando acesso…</main>;
  }
    ...
    return (
      <main className="grid min-h-screen place-items-center bg-[#0E0E0E] p-6">
        <section className="w-full max-w-md rounded-2xl border border-[#5a461c] bg-[#121212] p-8 text-center shadow-2xl">
          ...
          {!showConfirmation ? (
            <div className="py-12">
              <p className="text-sm font-bold tracking-[.18em] text-[#FFC107]">CR CONNECT</p>
              <h1 className="mt-5 text-3xl font-bold">Preparando seu acesso…</h1>
              <p className="mt-4 text-lg text-zinc-300">Estamos enviando seu link seguro.</p>
            </div>
          ) : (
            <div className="py-8">
              <p className="text-sm font-bold tracking-[.18em] text-[#FFC107]">PASSO IMPORTANTE</p>
