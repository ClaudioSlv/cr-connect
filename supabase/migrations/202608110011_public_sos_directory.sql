...
returns table (id uuid, name text, latitude numeric, longitude numeric, emergency_services text[], emergency_radius_km integer)
language sql security definer set search_path = public as $$
  select id, name, latitude, longitude, emergency_services, emergency_radius_km
